...
class Student:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"F:\facial_recognition_system\college_images\frec1.png")
        img=img.resize((500,130),Image.ANTIALIAS)
        self.photoimg=ImageTk.PhotoImage(img)

        self.btn1=Button(self.root,command=self.open_img,image=self.photoimg,cursor="hand2")
        self.btn1.place(x=0,y=0,width=500,height=130)

        # second image
        img_1=Image.open(r"F:\facial_recognition_system\college_images\frec2.png")
        img_1=img_1.resize((500,130),Image.ANTIALIAS)
        self.photoimg1=ImageTk.PhotoImage(img_1)

        self.btn2=Button(self.root,command=self.open_img_2,image=self.photoimg1,cursor="hand2")
        self.btn2.place(x=500,y=0,width=500,height=130)


        # third image
        img_2=Image.open(r"F:\facial_recognition_system\college_images\frec3.png")
        img_2=img_2.resize((500,130),Image.ANTIALIAS)
        self.photoimg2=ImageTk.PhotoImage(img_2)

        self.btn3=Button(self.root,command=self.open_img_3,image=self.photoimg2,cursor="hand2")
        self.btn3.place(x=1000,y=0,width=500,height=130)

        # bg image
        img3=Image.open(r"F:\facial_recognition_system\college_images\Whitebg.jpg")
        ...
        img_left=Image.open(r"F:\facial_recognition_system\college_images\frec3.png")
        ...
        dep_combo["values"]=("Select Department","Computer Application","IT","Civil","Mechanical")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","BCA","MCA","BTECH","IT")
        ...
        #class division
        class_div_label=Label(class_Student_frame,text="Section / Group:",font=("times new roman",13,"bold"),bg="white")
        ...
        #Subject Teacher
        teacher_label=Label(class_Student_frame,text="Subject Teacher:",font=("times new roman",13,"bold"),bg="white")
        ...
        img_right=Image.open(r"F:\facial_recognition_system\college_images\StudentDetail.png")
        ...
        search_combo["values"]=("Select","student_id","roll",)
    ...
    def open_img(self):
        ...
        img=Image.open(fln)
        img_browse=img.resize((500,130),Image.ANTIALIAS)
        self.photoimg_browse=ImageTk.PhotoImage(img_browse)
        self.btn1.config(image=self.photoimg_browse)
    ...
    def open_img_2(self):
        ...
        img_browse_1=img_1.resize((500,130),Image.ANTIALIAS)
        self.photoimg_browse_1=ImageTk.PhotoImage(img_browse_1)
        self.btn2.config(image=self.photoimg_browse_1)
    ...
    def open_img_3(self):
        ...
        img_browse_2=img_2.resize((500,130),Image.ANTIALIAS)
        self.photoimg_browse_2=ImageTk.PhotoImage(img_browse_2)
        self.btn3.config(image=self.photoimg_browse_2)
