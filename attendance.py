...
class Attendance:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"college_images\StudentManagementSystem.png")
        ...
        # second image
        img1=Image.open(r"college_images\att1.png")
        ...
        # bg image
        img3=Image.open(r"college_images\Whitebg.jpg")
        ...
        img_left=Image.open(r"college_images\sad.png")
        ...
        left_inside_frame.place(x=0,y=135,width=720,height=470)
