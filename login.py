...
class Login_Window:
    def __init__(self,root):
        ...
        # bg image
        self.bg=ImageTk.PhotoImage(file=r"F:\facial_recognition_system\college_images\bglogin.png")
        ...
        img1=Image.open(r"college_images\lgicon.png")
        ...
        self.txtuser.place(x=40,y=189,width=270)

        password=lbl=Label(frame,text="Password",font=("times new roman",15,"bold"),fg="white",bg="black")
        password.place(x=70,y=225)

        self.txtpass=ttk.Entry(frame,font=("times new roman",15,"bold"))
        self.txtpass.place(x=40,y=259,width=270)

        # ============ Icon Images ==================

        img2=Image.open(r"college_images\lgicon.png")
        img2=img2.resize((25,25),Image.ANTIALIAS)
        self.photoimage2=ImageTk.PhotoImage(img2)
        lblimg2=Label(image=self.photoimage2,bg="black",borderwidth=0)
        lblimg2.place(x=650,y=323,width=25,height=25)

        img3=Image.open(r"college_images\lpass.png")
        ...
        # forget button
        forgetbtn=Button(frame,text="Forgot Password",command=self.forgot_password_window,font=("times new roman",10,"bold"),borderwidth=0,fg="white",bg="black",activeforeground="white",activebackground="black")
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            messagebox.showinfo("Success","Welcome to FRAS")
        else:
    ...
    def forgot_password_window(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                new_password=Label(self.root2,text="Enter New Password",font=("times new roman",15,"bold"),fg="black",bg="white")
...
class Register:
    def __init__(self,root):
        ...
        self.photoimage1=ImageTk.PhotoImage(img1)
        b1=Button(frame,image=self.photoimage1,command=self.return_login,borderwidth=0,cursor="hand2",bg="black")
